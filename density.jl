...
function two_electron_density(p::QED_CCSD_PARAMS)
    ...
    # - 1 ∑_kcdl(v_aibk t_cjdl sᵗ_ckdl)
    # - 1 ∑_ckdl(v_aicj t_bkdl sᵗ_ckdl)
    # - 1 ∑_ckdl(v_ajck t_bidl sᵗ_ckdl)
    # - 1 ∑_kcdl(v_akbj t_cidl sᵗ_ckdl)
    # - 1 ∑_ckdl(v_bjci t_akdl sᵗ_ckdl)
    # - 1 ∑_kcld(s_alck u_bjdi sᵗ_ckdl)
    # - 1 ∑_ckdl(s_bick u_ajdl sᵗ_ckdl)
    # - 1 ∑_kcld(s_blck u_aidj sᵗ_ckdl)
    # - 1 ∑_cdkl(s_cidl u_akbj sᵗ_ckdl)
    # - 1 ∑_cdkl(s_cjdl u_aibk sᵗ_ckdl)
